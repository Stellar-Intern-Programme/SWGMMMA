...
import {login, defaultState} from '../src/actions/authActions';
...
const Register = ({
  ...
  AuthPropsReducer,
  'completeForgotPassword' | 'register' | 'codeRegister' | 'forgotPassword'
>) => {
  ...
  const loginRequest = async () => {
    ...
    await login({email: values.email, password: values.password, onSuccess});
  };
